...
def main():
    ...
    # NOTE This section of code creates the CID-Patent ID Dictionary. Comment out if you have run this already and saved as pkl
    ...
    # Skip this if you are loading the pkl file
    ...
    # NOTE if you have made it here before, you can load the CID-Patent ID Dictionary from pkl instead and comment out previous code
